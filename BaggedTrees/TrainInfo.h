...
public:
	...
	int s;				//related to number of random subset for approximate the best splits. depends on interactions between features
	...
	TrainInfo(): bagN(60), seed(1), alpha(0), rms(true), mu(0), s(1) {};
};
